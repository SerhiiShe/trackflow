...
export interface TaskHistoryTableRowProps {
  task: TaskLog
...
export const TaskHistoryTableRow = ({
  task,
  onDeleteClick,
  isDeleting,
  onEditClick,
  ...
  return (
    <tr key={task.id} className="bg-white border-b border-gray-300 hover:bg-gray-50">
      ...
      <td className="px-6 py-4 font-medium text-gray-900">{task.projects?.clients?.name || '—'}</td>
      <td className="px-6 py-4 font-medium text-gray-900">
