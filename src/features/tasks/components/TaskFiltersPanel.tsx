...
export const TaskFiltersPanel = ({ filters, onChange }: TaskFiltersPanelProps) => {
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
